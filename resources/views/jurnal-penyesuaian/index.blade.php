                    ...
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            ...
                            <div class="mb-3">
                                ...
                                <a href="{{ route('jurnal-penyesuaian.create') }}" class="btn btn-success" title="Tambah" data-toggle="tooltip"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        @forelse ($jurnal_penyesuaian as $item)
                            <tr>
                                ...
                                <td style="vertical-align: middle">
                                    <a href="{{ route('jurnal-penyesuaian.edit', $item) }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
